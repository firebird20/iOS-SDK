...
#define PayoneParameters_OnlineBankTransferTypeParameter_IDEAL        @"IDL";

//austria types
#define PayoneParameters_BankgroupType_ARZ_OVB        @"ARZ_OVB";
#define PayoneParameters_BankgroupType_ARZ_BAF        @"ARZ_BAF";
#define PayoneParameters_BankgroupType_ARZ_NLH        @"ARZ_NLH";
#define PayoneParameters_BankgroupType_ARZ_VLH        @"ARZ_VLH";
#define PayoneParameters_BankgroupType_ARZ_BCS        @"ARZ_BCS";
#define PayoneParameters_BankgroupType_ARZ_HTB        @"ARZ_HTB";
#define PayoneParameters_BankgroupType_ARZ_HAA        @"ARZ_HAA";
#define PayoneParameters_BankgroupType_ARZ_IKB        @"ARZ_IKB";
#define PayoneParameters_BankgroupType_ARZ_OAB        @"ARZ_OAB";
#define PayoneParameters_BankgroupType_ARZ_IMB        @"ARZ_IMB";
#define PayoneParameters_BankgroupType_ARZ_GRB        @"ARZ_GRB";
#define PayoneParameters_BankgroupType_ARZ_HIB        @"ARZ_HIB";
#define PayoneParameters_BankgroupType_BA_AUS       @"ARBA_AUS";
#define PayoneParameters_BankgroupType_BAWAG_BWG       @"ARBAWAG_BWG";
#define PayoneParameters_BankgroupType_BAWAG_PSK       @"ARBAWAG_PSK";
#define PayoneParameters_BankgroupType_BAWAG_ESY       @"ARBAWAG_ESY";
#define PayoneParameters_BankgroupType_BAWAG_SPD       @"ARBAWAG_SPD";
#define PayoneParameters_BankgroupType_SPARDAT_EBS       @"ARSPARDAT_EBS";
#define PayoneParameters_BankgroupType_SPARDAT_BBL       @"ARSPARDAT_BBL";
#define PayoneParameters_BankgroupType_RAC_RAC       @"ARRAC_RAC";
#define PayoneParameters_BankgroupType_HRAC_OOS       @"ARHRAC_OOS";
#define PayoneParameters_BankgroupType_HRAC_SLB       @"ARHRAC_SLB";
#define PayoneParameters_BankgroupType_HRAC_STM       @"ARHRAC_STM";
    
    // netherland types
#define PayoneParameters_BankgroupType_ABN_AMRO_BANK       @"ARABN_AMRO_BANK";
#define PayoneParameters_BankgroupType_RABOBANK       @"ARRABOBANK";
#define PayoneParameters_BankgroupType_FRIESLAND_BANK       @"ARFRIESLAND_BANK";
#define PayoneParameters_BankgroupType_ASN_BANK       @"ARASN_BANK";
#define PayoneParameters_BankgroupType_SNS_BANK       @"ARSNS_BANK";
#define PayoneParameters_BankgroupType_TRIODOS_BANK       @"ARTRIODOS_BANK";
#define PayoneParameters_BankgroupType_SNS_REGIO_BANK       @"ARSNS_REGIO_BANK";
#define PayoneParameters_BankgroupType_ING_BANK       @"ARING_BANK";
